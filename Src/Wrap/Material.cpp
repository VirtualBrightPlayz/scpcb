...
Material Material::create(const Shader& shd, const std::vector<Texture>& t) {
    Material mat;
    mat.shader = shd;
    mat.textures = t;
...
Material Material::create(const Shader& shd, const Texture& t) {
    Material mat;
    mat.shader = shd;
...
Material Material::create(const Shader& shd) {
    Material mat;
    mat.shader = shd;
...
PGE::Material* Material::getInternal() const {
    return internal;
}
