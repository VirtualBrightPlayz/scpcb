...
void FillRoom_cont_513_3(Room* r) {
    Door* d = CreateDoor(r->x - 704.f * RoomScale, 0, r->z + 304.f * RoomScale, 0, r, false, DOOR_TYPE_DEF, r->roomTemplate->name);
    //: d\buttons[0] = False
    d->autoClose = false;
    ...
    Item* it = CreateItem("scp513", r->x - 32.f * RoomScale, r->y + 196.f * RoomScale, r->z + 688.f * RoomScale);
