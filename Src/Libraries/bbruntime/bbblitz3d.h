...
class MeshModel* bbCreateMesh(class Object* p);
class MeshModel* bbCreateCube(class Object* p);
class MeshModel* bbCreateSphere(int segs, class Object* p);
class MeshModel* bbCreateCylinder(int segs, int solid, class Object** p);
class MeshModel* bbCreateCone(int segs, int solid, class Object* p);
class MeshModel* bbDeepCopyMesh(class MeshModel* m, class Object* p);
