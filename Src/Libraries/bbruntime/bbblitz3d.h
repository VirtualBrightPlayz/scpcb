...
class Object* bbCreateMesh(class Object* p);
class Object* bbCreateCube(class Object* p);
class Object* bbCreateSphere(int segs, Object* p);
class Object* bbCreateCylinder(int segs, int solid, Object* p);
class Object* bbCreateCone(int segs, int solid, Object* p);
class Object* bbCopyMesh(class MeshModel* m, Object* p);
...
class Object* bbCopyEntity(class Object* e, Object* p);
