...
class MeshModel* bbCreateSphere(int segs, Object* p);
class MeshModel* bbCreateCylinder(int segs, int solid, Object* p);
class MeshModel* bbCreateCone(int segs, int solid, Object* p);
class MeshModel* bbDeepCopyMesh(class MeshModel* m, Object* p);
