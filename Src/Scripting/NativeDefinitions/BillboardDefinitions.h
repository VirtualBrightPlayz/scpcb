...
class BillboardDefinitions : public NativeDefinition {
    private:
        ...
        Billboard* createBillboard(const PGE::Vector3f& pos, const PGE::String& textureName, const PGE::Vector3f& scale);
        RotatedBillboard* createBillboardRotated(const PGE::Vector3f& pos, const PGE::String& textureName, const PGE::Vector3f& rotation, const PGE::Vector3f& scale);
