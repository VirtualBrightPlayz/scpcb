...
void FillRoom_lck_broke_2c(Room* r) {
    ...
    bbPositionEntity(r->objects[0],r->x+668*RoomScale,1.1,r->z-96.f*RoomScale,true);
    ...
    bbPositionEntity(r->objects[1],r->x+96.f*RoomScale,1.1,r->z-668.f*RoomScale,true);
