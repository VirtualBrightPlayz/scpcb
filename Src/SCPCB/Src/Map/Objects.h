...
float UpdateElevators(float state, struct Door* door1, struct Door* door2, Object* room1, Object* room2, class Event* event);

float UpdateElevators2(float State, struct Door* door1, struct Door* door2, Object* room1, Object* room2, class Event* event);
