Function FillRoom_test_860_2(r.Rooms)
    ...
    it = CreatePaper("doc8601", r\x + 672.0 * RoomScale, r\y + 176.0 * RoomScale, r\z + 335.0 * RoomScale)
    RotateEntity it\collider, 0, r\angle+10, 0
    EntityParent(it\collider, r\obj)

    it = CreatePaper("doc860", r\x + 1152.0 * RoomScale, r\y + 176.0 * RoomScale, r\z - 384.0 * RoomScale)
