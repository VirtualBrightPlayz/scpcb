...
void CreateMap() {
    ...
    for (int iterator87 = 0; iterator87 < RoomTemplate::getListSize(); iterator87++) {
        ...
        if (((rt->zones & zone)!=0) && (rt->maxAmount>0) && (rt->shape!=ROOM0)) {
            ...
            prioritizedTemplates.insert(prioritizedTemplates.begin() + bbRand(0, (int)prioritizedTemplates.size()), rt);
        }
    }
    ...
    for (int iterator89 = 0; iterator89 < RoomTemplate::getListSize(); iterator89++) {
        ...
        if (((rt->zones & zone)!=0) && (rt->maxAmount<0) && (rt->shape!=ROOM0)) {
            randomTemplates.insert(randomTemplates.begin() + bbRand(0, (int)randomTemplates.size()), rt);
