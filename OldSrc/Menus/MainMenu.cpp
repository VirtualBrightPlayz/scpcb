    ...
    if (currState == MainMenuState::Main) {
        ...
        switch (currState) {
            case MainMenuState::NewGame: {
                ...
                bbColor(255, 255, 255);
                bbSetFont(uiAssets->font[1]);
                bbText(x + width / 2, y + height / 2, txtMgmt->getLocalTxt("mnu_new"), true, true);
            ...
            case MainMenuState::LoadGame: {
                ...
                bbColor(255, 255, 255);
                bbSetFont(uiAssets->font[1]);
                bbText(x + width / 2, y + height / 2, txtMgmt->getLocalTxt("mnu_load"), true, true);
                ...
                bbText(x + (int)(20.f * MenuScale), y + (int)(20.f * MenuScale), txtMgmt->getLocalTxt("mnu_nosav"));
                //				Else
            ...
            case MainMenuState::Options: {
                ...
                bbColor(255, 255, 255);
                bbSetFont(uiAssets->font[1]);
                bbText(x + width / 2, y + height / 2, txtMgmt->getLocalTxt("mnu_opt"), true, true);
            ...
            case MainMenuState::CustomMap: {
                ...
                bbColor(255, 255, 255);
                bbSetFont(uiAssets->font[1]);
                bbText(x + width / 2, y + height / 2, txtMgmt->getLocalTxt("mnu_loadmap"), true, true);
                bbSetFont(uiAssets->font[0]);
                ...
                //				If (SavedMaps(0)="") Then
                bbText(x + (int)(20.f * MenuScale), y + (int)(20.f * MenuScale), txtMgmt->getLocalTxt("mnu_nomap"));
                //				Else
                //					x = x + (int)(20.f * MenuScale)
                //					y = y + (int)(20.f * MenuScale)
