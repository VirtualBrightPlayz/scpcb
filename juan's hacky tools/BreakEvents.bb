Function CreateEvent(eventname$, roomname$, id%, prob# = 0.0)
	...
	WriteLine(roomFile,"Function UpdateEvent"+capeventname+"(e.Event)")
	WriteLine(roomFile,Chr(9)+"Local dist#, i%, temp%, pvt%, strtemp$, j%, k%")
	WriteLine(roomFile,"")
	WriteLine(roomFile,Chr(9)+"Local p.Particles, n.NPC, r.Room, e2.Event, it.Item, em.Emitters, sc.SecurityCams, sc2.SecurityCams")
	WriteLine(roomFile,"")
