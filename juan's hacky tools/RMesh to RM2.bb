...
Function LoadRMesh(file$)
	...
	For i=1 To count ;drawn mesh
		...
		For j=0 To 1
			...
			If temp1i<>0 Then
				temp1s=ReadString(f)
				temp1s = Replace(temp1s,"strg_939_2","strg_939_3")
				temp1s = Replace(temp1s,"extend_gatea_1","extend_gatea")
...
LoadRMesh("GFX/Map/hll_toilets_2/hll_toilets_2.rmesh")

;~IDEal Editor Parameters:
;~F#1C#2B#3B#4C#62#69#7F#87#8F#97
;~C#Blitz3D